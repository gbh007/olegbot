...
export function useBotGet(): [
  Response<BotModel | null>,
  PostAction<botRequest>
] {
  const [response, fetchData] = useAPIPost<botRequest, BotModel>(
    "/api/bot/get"
  );
...
export function useBotRunningList(): [
  Response<Array<number> | null>,
  PostAction<void>
] {
  const [response, fetchData] = useAPIGet<Array<number>>(
    "/api/bot/running/list"
  );
